...
Array: A Data structure with contiguous memory with elements of same type. 
...
Q.8.
The majority element is an element that makes up more than half of the items in
