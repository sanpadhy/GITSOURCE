...
// Notes:
//
// The life of the switch is to pull its dataMsg channel, and feed it it
...
const (
	...
	// we're toast.
	METRICS_CASSANDRA_TIMEOUT_ENQUEUE_SECONDS   = 3
	METRICS_CASSANDRA_WAIT_TO_RECONNECT_SECONDS = 3
	//
	...
	METRICS_CASSANDRA_FIELDS_PER_POINT_ESTIMATE = 32
)
...
var cassandraUPCollectorFactory userPasswordCollectorFactory
...
func init() {
	...
	cassandraUPCollectorFactory = func() userPasswordCollector {
